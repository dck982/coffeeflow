...
- **VDD de l'ADS1115 vient du connecteur I2C Waveshare en 3,3 V** ; relever les résistances de tirage SDA/SCL du breakout et vérifier que le bus de l'ESP32 reste à **3,3 V**. Le 3,3 V de l'AMS1117 est un rail distinct : il alimente le pont NTC et se mesure sur **A0**. La NTC va de ce rail à **A1**, et **2,193 kΩ** relient A1 à GND. Toutes les masses sont communes.
- Les tensions du montage ont déjà été vérifiées sur la machine. Pour la conversion, employer **le rapport des lectures A0/A1** avec le même PGA ; ne pas utiliser la valeur absolue mesurée en sortie du LDO comme constante. La vérification des niveaux électriques reste une propriété du montage, distincte du calcul ratiométrique.
