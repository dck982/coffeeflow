...
![pir](https://files.seeedstudio.com/wiki/Grove-Shield-for-Seeeduino-XIAO/img/xiao_-Preview-25.png)
...
[**Get One Now ðŸ–±ï¸**](https://www.seeedstudio.com/Grove-Shield-for-Seeeduino-XIAO-p-4621.html)

#### Hardware Overview

![](https://files.seeedstudio.com/wiki/Grove-Shield-for-Seeeduino-XIAO/img/hardware-overview.png)
...
| ![pir](https://files.seeedstudio.com/wiki/wiki_english/docs/images/arduino_logo.jpg) | ![pir](https://files.seeedstudio.com/wiki/wiki_english/docs/images/raspberry_pi_logo_n.jpg) 
...
| ![pir](https://files.seeedstudio.com/wiki/Seeeduino-XIAO/img/seeeduino-XIAO-thumbnail.jpg) | ![pir](https://files.seeedstudio.com/wiki/Grove-Doppler-Radar/IMG/small.png) | ![pir](https://files.seeedstudio.com/wiki/Grove-Shield-for-Seeeduino-XIAO/img/xiao_-Thumbnail-27.png) 
...
![pir](https://files.seeedstudio.com/wiki/Grove-Doppler-Radar/IMG/pin-1.png)
...
![pir](https://files.seeedstudio.com/wiki/Grove-Doppler-Radar/IMG/hardware_connection.jpg)

tip
Please plug the USB cableï¼Œ Doppler Radar Interface into Seeed Studio XIAO expansion board Interface gently, otherwise you may damage the port.
...
![Grove-Doppler-Radar'' OUTCOME](https://files.seeedstudio.com/wiki/Grove-Doppler-Radar/IMG/outcome_1.png) **Figure 3** . *No object approaching*
And if there's an object approaching the radar or passing by, the outcome will alter as below:

![Grove-Doppler-Radar'' OUTCOME](https://files.seeedstudio.com/wiki/Grove-Doppler-Radar/IMG/outcome2.png) **Figure 3** . *Object approaching*
note
